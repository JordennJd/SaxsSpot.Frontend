...
const Header = () => {
  ...
  return (
    <header 
      className="bg-gradient-to-r from-blue-900 to-purple-900 shadow-lg sticky top-0 z-10"
    >
      <div className="container mx-auto px-4 py-3 flex items-center cursor-pointer">
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <span className="text-purple-500">Spot</span>
          </h1>
        </div>
        ...
        <nav className="ml-auto hidden md:block">
          <ul className="flex space-x-6 font-mono">
            ...
            <li onClick={() => navigate('/jobs')} className="text-gray-300 hover:text-yellow-300 transition-colors flex items-center">
              <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
